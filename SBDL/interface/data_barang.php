...
$barang = mysqli_query($koneksi, "SELECT * FROM tabel_barang");
$no = 1;
...
?>
			<tr>
				...
				<td align="center">
				    <a href="?home=detail_barang&no=<?php echo $baris['kd_brg'];?>" type="button" class="btn btn-info">Detail</a>
					<a href="?home=edit_barang&no=<?php echo $baris['kd_brg'];?>"><button type="button" class="btn btn-success">Edit</button></a>
					<a href="?home=delete_barang&no=<?php echo $baris['kd_brg'];?>"><button type="button" class="btn btn-danger">delete</button></a>
